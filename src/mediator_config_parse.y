...
%token TOK_PRESERVE_OBDOMAIN TOK_REWRITE_SSL_CERTS
...
tombstoneConfig:           tombstone_begin tombstoneList tombstone_end
{
};
...
tombstone_end:             TOK_TOMBSTONE_CONFIG TOK_END
{
};

tombstoneList:           tombstoneStmt
                       | tombstoneList tombstoneStmt
;

tombstoneStmt:         | genTombstoneConfig
                       | tombstoneIdConfig
                       | EOS
;
...
tombstoneIdConfig:        TOK_TOMBSTONE_CONFIGURED_ID VAL_INTEGER EOS
{
